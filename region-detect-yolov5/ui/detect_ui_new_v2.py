...
# Form implementation generated from reading ui file 'detect_ui_new_v2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(949, 566)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/camera2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(4, _translate("MainWindow", "yolo+deepsort"))
        self.comboBox.setItemText(5, _translate("MainWindow", "helmet_s"))
        self.comboBox.setItemText(6, _translate("MainWindow", "helmet_l"))
        self.comboBox.setItemText(7, _translate("MainWindow", "helmet_m"))
        ...
        self.comboBox_2.setItemText(0, _translate("MainWindow", "请选择视频"))
        self.comboBox_2.setItemText(1, _translate("MainWindow", "钢筋加工厂"))
        self.comboBox_2.setItemText(2, _translate("MainWindow", "主墩"))
        self.comboBox_2.setItemText(3, _translate("MainWindow", "桥球机"))
        self.comboBox_2.setItemText(4, _translate("MainWindow", "特大桥"))
