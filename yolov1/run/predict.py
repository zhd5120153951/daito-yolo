...
if __name__ == '__main__':
    ...
    model.eval()
    model.cuda()
    # image_name = '../../data_dir/example/000007.jpg'
    # image_name = '../../data_dir/example/person.jpg'
    # image_name = '../../data_dir/combine_doc/images/000007.jpg'
    image_name = '../../data_dir/combine_doc/images/009889.jpg'
    ...
    # 根据自己的保存路径修改
    # ------------------------------------------------------------------------------------------------------------------
    result_img = '../../data_dir/example/' + "result_" + title_name
    # print(result_img)
