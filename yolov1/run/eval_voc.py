        ...
        for d, image_id in enumerate(image_ids):
            ...
            if (image_id, class_) in target:
                ...
                for bbgt in BBGT:
                    ...
                    union = (bb[2] - bb[0] + 1.) * (bb[3] - bb[1] + 1.) + (bbgt[2] - bbgt[0] +
                                                                           1.) * (bbgt[3] - bbgt[1] + 1.) - inters
                    if union == 0:
                        print(bb, bbgt)
...
if __name__ == '__main__':
    ...
    for image_path in tqdm(image_list):
        ...
        # cv2.imwrite(r'A:\Learning_doc\detection_learning\yolov1\resualt_dir/'+image_path, image)
        # count += 1
        # # 只输出count张图像
        # if count == 200:
        #     break
