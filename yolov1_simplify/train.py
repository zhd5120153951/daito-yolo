...
device = 'cuda'
# file_root = 'VOCdevkit/VOC2007/JPEGImages/'#相对路径
file_root = 'E:\\Source\\Github\\datasets\\yolov1_simplify\\VOC2007\\JPEGImages\\'
batch_size = 4  # 若显存较大可以调大此参数 4，8，16，32等等
learning_rate = 0.001
num_epochs = 20
...
for epoch in range(num_epochs):
    ...
    # torch.save(net.state_dict(), 'yolo.pth')#state_dict()只保存模型权重,没有模型结构--去掉后就是保存整个模型对象
    torch.save(net.state_dict(), 'yolov1.pt')
